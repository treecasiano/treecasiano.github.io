...
description: "A curated, annotated list of the JavaScript, Node, Express, Angular, React, and ES6 resources for leveling up rapidly."
group: navigation
---
{% include JB/setup %}
...
To use an RPG analogy, as I chronically find myself doing, what do you do now that you are out of the starting zone but still underpowered, alone, and generally unfit to join a party "real players?" You don't want to spend your precious hours grinding fruitlessly or squander your dwindling supply of gold on overpriced trainers who promise you more than they usually deliver. You're afraid to connect with more advanced players lest you embarrass yourself or irritate others. Most of the interesting are still inaccessible.
...
On this page I am assembling a collection of worthwhile resources that are helping me get to the next level. I will only add links if the tutorials or books are worth the time and energy I spent on them. The focus here is on full stack JavaScript, with enough CSS thrown in to keep my front-end sensibilities happy.
